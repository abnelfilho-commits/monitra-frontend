...
export default function DashboardProfissional() {
  ...
  return <>
    <section className="care-line-context" aria-label="Contexto assistencial">
      <div><strong>Seu contexto assistencial</strong><p>Selecione uma Linha autorizada para acompanhar sua população.</p></div>
